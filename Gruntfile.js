module.exports = function (grunt) {
    grunt.initConfig({
        concat: {
            basic: {
                src: ['www/js/bootstrap/*.js', 'www/js/angular/angular.js', 'www/js/angular/dependecies/*.js', 'www/js/module/*.js', 'www/js/factory/*.js', 'www/js/controller/*.js', 'www/js/controller/filtro/*.js'],
                dest: 'www/js/main.js',
            },
            extras: {
